...
import codeidpng from "./../../assets/images/jenius.jpg";
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <img className="h-10 w-10" src={codeidpng} alt="Workflow" />
              </div>
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <a
                    href="#"
                    className={
                      active === "dashboard" ? activeClass : disactiveClass
                    }
                  ...
                  <a
                    href="#"
                    className={active === "team" ? activeClass : disactiveClass}
                  ...
                  <a
                    href="#"
                    className={
                      active === "projects" ? activeClass : disactiveClass
                    }
                  ...
                  <a
                    href="#"
                    className={
                      active === "calendar" ? activeClass : disactiveClass
                    }
                  ...
                  <a
                    href="#"
                    className={
                      active === "reports" ? activeClass : disactiveClass
                    }
                ...
                <div className="ml-3 relative">
                  <div>
                    <button
                      ...
                      onClick={() =>
                        setIsDropDownShow(
                          isDropDownShow === true ? false : true
                        )
                      }
